                ...
                <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">Creación de Cargas</li>
                                        </ol>
                                    </div><!--end col-->
                                 </div><!--end col-->  
                                </div><!--end row-->                                                              
                    ...
                    <div class="row">
                        <div class="col-lg-9 offset-md-2">
                            <div class="card">
                                <div class="card-body"> 
									<form method="post" action="cargas_guardar.php" class="form-horizontal " id="validate" role="form" id="formulario" name="formulario" class="needs-validation" autocomplete="on" onsubmit="return valida_envia();return false;" enctype="multipart/form-data" >																										
										<div class="row">											
											<div class="col-md-6">
									...
									<div class="mt-3" align="center">
										...
										<button type="button" onClick="javascript:location.href='cargas.php';" class="btn btn-danger waves-effect waves-light">CANCELAR</button>
									</div>
								</form>		
                                </div> <!-- end card-body -->
                            </div> <!-- end card -->                                       
				   ...
				   $(document).ready(function(){
					$("#cliente").on('change', function () {
						$("#cliente option:selected").each(function () {
							...
							$.post("get_servicios.php", { id_cliente: id_cliente }, function(data) {
								$("#servicios").html(data);
							});			
						});
				   });
