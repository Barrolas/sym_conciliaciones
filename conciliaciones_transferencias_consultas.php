                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="datatable2" class="table dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "EXEC [_SP_CONCILIACIONES_TRANSFERENCIAS_LISTA]";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="col-1">
                                                <?php if ($transferencia["RUT_CLIENTE"] <> 0) { ?>
                                                    <a data-toggle="tooltip" title="Ver gestiones" href="conciliaciones_gestiones.php?rut_cliente=<?php echo $transferencia["RUT_CLIENTE"];?>&transaccion=<?php echo $transferencia["TRANSACCION"];?>&rut_ordenante=<?php echo $transferencia["RUT"];?>" class="btn btn-icon btn-rounded btn-info ml-2">
                                            ...
                                            <td class="col-1">
                                                <?php if ($transferencia["RUT_CLIENTE"] <> 0) { ?>
                                                    <a data-toggle="tooltip" title="Estado de la conciliación"  class="text-center pl-3 text-success"><i class="feather-24" data-feather="thumbs-up"></i></a>
                                                <?php } else { ?>
                                                    <a data-toggle="tooltip" title="Estado de la conciliación" class="text-center pl-3 text-danger"><i class="feather-24" data-feather="thumbs-down"></i></a>
                                                <?php }; ?>
