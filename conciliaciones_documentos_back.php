            ...
            <div class="container-fluid">
                ...
                <div class="container-fluid px-2">
                    <div class="col-12 px-3">
                        ...
                        <?php if ($existe == 1) { ?>
                            <form id="form_concilia" method="post" class="mr-0" action="conciliaciones_pareos_guardar.php?rut_ordenante=<?php echo $rut_ordenante ?>&transaccion=<?php echo $transaccion ?>&rut_deudor=<?php echo $rut_deudor ?>" onsubmit="return valida_envia2();return false;">
                            <?php } else { ?>
                                                    ...
                                                    <td align="left">
                                                        ...
                                                        <div class="form-group row align-items-center mb-0">
                                                            ...
                                                            <div class="col-auto p-0">
                                                                <button type="submit" class="btn btn-md btn-secondary ml-0 mb-0" id="search_button" style="transform: translateX(-6px);" <?php echo ($rut_deudor === '' || $rut_deudor === '0' || $existe === 0) ? 'disabled' : ''; ?>><i class="fa fa-search custom-size py-1"></i></button>
                                                            </div>
                                                        </div>
                                                    </td>

                                                    <td align="right" class="mr-0">
                                                        <div class="form-group row align-items-end justify-content-end mb-0 mr-0">
                                                            <div class="col-auto mr-0">
                                                                <button type="submit" class="btn btn-md btn-info mr-0" <?php echo ($rut_deudor === '' || $rut_deudor === '0' || $existe === 0) ? 'disabled' : ''; ?>><i class="fa fa-plus"></i> CONCILIAR</button>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td align="right">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#datatable2').on('change', '.valor-checkbox', function() {
            ...
            let valor = parseFloat(rowData[1]); // Suponiendo que la columna oculta es la segunda columna (índice 1)
