		...
		<div class="page-content">
			<div class="container my-5">
				<div class="text-center mb-4">
					<h1 class="display-6">Carga de SISREC</h1>
					<p class="text-muted">Módulo para la carga de cartolas SISREC</p>
				</div>
				...
				<div class="row align-items-center mt-5">
					...
					<div class="col-lg-6 mx-auto">
						<div class="card shadow-lg">
							<div class="card-body">
								<!-- Título Principal -->
								<h4 class="card-title text-center mb-4">Subir Cartola SISREC</h4>
								<!-- Formulario -->
								<form method="post" action="cargas_sisrec_guardar.php" id="formulario" enctype="multipart/form-data">
									<div class="mb-3">
								...
								<ul class="list-group list-group-flush mt-3">
									...
									<li class="list-group-item">
										...
										<strong>Formato válido:</strong> El archivo debe estar en formato Excel (<strong>.xls</strong>).
									</li>
									<li class="list-group-item">
			...
			document.getElementById('formulario').addEventListener('submit', function(e) {
				...
				if (extension !== 'xls') {
					...
					Swal.fire({
						...
						text: 'El archivo debe estar en formato .xls',
					});
					return false;
				}
