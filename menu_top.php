                    ...
                    <ul class="list-unstyled topbar-nav float-right mb-0">  
						...
						<li class="dropdown">
                            ...
                            <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                                ...
                                <span class="ml-1 nav-user-name hidden-sm"> <i class="fa fa-user-circle px-2" aria-hidden="true"></i><b></b> <?php echo $_SESSION["NOMBRES"];?> (<?php echo $_SESSION["PERFIL"];?>) <i class="fa fa-bell px-2" aria-hidden="true"></i></span>
